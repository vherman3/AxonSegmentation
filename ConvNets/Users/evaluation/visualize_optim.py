...
def visualize_learning(model_number, restore = False, restored_model=1, start_visu=0):
    ...
    folder_model = parent_path+'/dataset/model_parameters%s'%model_number

    folder_restored_model = parent_path+"/dataset/model_parameters%s/"%restored_model
...
visualize_learning(3, restore = True, restored_model=1, start_visu=0)