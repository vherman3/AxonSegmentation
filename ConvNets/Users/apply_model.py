...
def apply(path, model_number, mrf=False) :
...
def myelin(path):
    command = "/Applications/MATLAB_R2014a.app/bin/matlab -nodisplay -nosplash -r \"addpath(\'/Users/viherm/Desktop/myelin/\'); myelin(\'%s\');exit()\""%path
    print command
    os.system(command)
