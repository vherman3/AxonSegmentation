...
def learn_model(trainingset_path, learning_rate = 0.0005, verbose = 1, restore = True, restored_model = 1):
    ...
    # Results and Models
    result_number = 3
    folder_model = 'data/models/model_parameters%s'%result_number
    ...
    with tf.Session(config=tf.ConfigProto(log_device_placement=True)) as sess:
        last_epoch = 0
        if restore :
            folder_restored_model = "data/models/model_parameters%s/"%restored_model
